...
desc 'Generate documentation for the theme_envirashop extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ThemeEnvirashopExtension'
...
desc 'Test the theme_envirashop extension.'
...
namespace :test do
  desc 'Functional test the theme_envirashop extension.'
  ...
  desc 'Unit test the theme_envirashop extension.'
